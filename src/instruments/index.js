...
const INSTRUMENTS = [loveLanguages, attachment, coupleConversations, intimacyConditions, conflictStyle, enneagram, bigFive, hexaco, jungian, riasec, workingStyle, studyPractice, chronotype, numerology];
