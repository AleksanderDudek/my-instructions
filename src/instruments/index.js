...
const INSTRUMENTS = [loveLanguages, attachment, coupleConversations, intimacyConditions, attraction, conflictStyle, enneagram, bigFive, hexaco, jungian, riasec, workingStyle, studyPractice, chronotype, numerology];
