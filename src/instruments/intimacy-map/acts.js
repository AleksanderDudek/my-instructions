...
const ACTS = [
  ...
  ["structure", "open"],
  ["structure", "risk"],
].map(([section, id]) => ({ section, id, side: id.endsWith(".a") ? "a" : id.endsWith(".b") ? "b" : null }));
