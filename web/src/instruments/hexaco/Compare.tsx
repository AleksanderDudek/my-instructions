...
import { compare, type HexacoResult } from "./spec";
...
export function Compare({
  ...
  const { gaps, widest, honesty, mean, honestySplit } = compare(a, b);
  return (
    <>
      <Verdict
        t={t}
        ...
        body={t(honestySplit ? "compare.honestySplit" : "compare.body", {
