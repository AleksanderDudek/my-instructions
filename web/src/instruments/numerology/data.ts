...
const CUTS: [number, number, string][] = [[1,19,"Capricorn"],[2,18,"Aquarius"],[3,20,"Pisces"],[4,19,"Aries"],[5,20,"Taurus"],
  [6,20,"Gemini"],[7,22,"Cancer"],[8,22,"Leo"],[9,22,"Virgo"],[10,22,"Libra"],[11,21,"Scorpio"],[12,21,"Sagittarius"]];

const NUM: Record<number, unknown> = {
...
const FRIENDLY: Record<number, number[]> = {1:[1,2,3,5,6,9],2:[1,2,4,6,8,9],3:[1,3,5,6,7,9],4:[2,4,6,7,8],5:[1,3,5,7,9],
  6:[1,2,3,4,6,8,9],7:[3,4,5,7,9],8:[2,4,6,8],9:[1,2,3,5,6,7,9]};
const ELEM_PAIR: Record<string, number> = {"Fire|Air":20,"Earth|Water":20,"Fire|Earth":14,"Air|Water":14,"Fire|Water":9,"Earth|Air":9};
