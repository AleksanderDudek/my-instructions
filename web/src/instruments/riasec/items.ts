...
export type TypeKey = "realistic" | "investigative" | "artistic" | "social" | "enterprising" | "conventional";

const GLYPHS: Record<TypeKey, string> = {
  realistic: "⚒",
  investigative: "⌕",
  artistic: "✎",
  social: "♁",
 ...
 */
const ORDER: TypeKey[] = ["realistic", "investigative", "artistic", "social", "enterprising", "conventional"];

/** kind/scaleName are constant across this bank, so the rows stay readable. */
const row = (id: string, scale: TypeKey, reverse = false) =>
...
const ITEMS = [
  ...
  row("r4", "realistic"),
  row("r5", "realistic"),
  row("r6", "realistic", true),

  row("i1", "investigative"),
  row("i2", "investigative"),
  row("i3", "investigative"),
  row("i4", "investigative"),
  row("i5", "investigative"),
  row("i6", "investigative", true),
